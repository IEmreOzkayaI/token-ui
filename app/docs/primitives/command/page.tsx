  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ucommand component with live examples from ui/components/command-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/command-basic.tsx
import { Component } from "@/primitives/command"

export function UcommandExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
