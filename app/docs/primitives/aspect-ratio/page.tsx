...
import { UaspectUratio } from "@/primitives/aspect-ratio"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UaspectUratio } from "@/primitives/aspect-ratio"

export function UaspectUratioDemo() {
  return <UaspectUratio />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
