  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Usidebar component with live examples from ui/components/sidebar-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/sidebar-basic.tsx
import { Component } from "@/primitives/sidebar"

export function UsidebarExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
