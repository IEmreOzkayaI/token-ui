  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Udirection component with live examples from ui/components/direction-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/direction-basic.tsx
import { Component } from "@/primitives/direction"

export function UdirectionExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
