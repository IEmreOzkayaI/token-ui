...
export default function UcollapsiblePage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">Ucollapsible</h1>
        <p className="text-lg text-muted-foreground">Ucollapsible component with live examples from ui/components/collapsible-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/collapsible-basic.tsx
import { Component } from "@/primitives/collapsible"

export function UcollapsibleExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
