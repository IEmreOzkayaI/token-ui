...
export default function UprogressPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uprogress component with live examples from ui/components/progress-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/progress-basic.tsx
import { Component } from "@/primitives/progress"

export function UprogressExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
