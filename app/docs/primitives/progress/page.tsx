...
import { Uprogress } from "@/primitives/progress"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { Uprogress } from "@/primitives/progress"

export function UprogressDemo() {
  return <Uprogress />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        ...
        <section id="installation" className="space-y-4">
          ...
          <CodeBlock>{`pnpm dlx shadcn@latest add progress`}</CodeBlock>
        </section>
