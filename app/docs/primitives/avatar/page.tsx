  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uavatar component with live examples from ui/components/avatar-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/avatar-basic.tsx
import { Component } from "@/primitives/avatar"

export function UavatarExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
