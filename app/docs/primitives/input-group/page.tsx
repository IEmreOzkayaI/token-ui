...
export default function UinputUgroupPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UinputUgroup</h1>
        <p className="text-lg text-muted-foreground">UinputUgroup component with live examples from ui/components/input-group-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/input-group-basic.tsx
import { Component } from "@/primitives/input-group"

export function UinputUgroupExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
