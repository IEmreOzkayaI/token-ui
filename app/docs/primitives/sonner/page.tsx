  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Usonner component with live examples from ui/components/sonner-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/sonner-basic.tsx
import { Component } from "@/primitives/sonner"

export function UsonnerExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
