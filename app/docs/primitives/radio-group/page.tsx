...
export default function UradioUgroupPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UradioUgroup</h1>
        <p className="text-lg text-muted-foreground">UradioUgroup component with live examples from ui/components/radio-group-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/radio-group-basic.tsx
import { Component } from "@/primitives/radio-group"

export function UradioUgroupExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
