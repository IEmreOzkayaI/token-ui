...
export default function UnavigationUmenuPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UnavigationUmenu</h1>
        <p className="text-lg text-muted-foreground">UnavigationUmenu component with live examples from ui/components/navigation-menu-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/navigation-menu-basic.tsx
import { Component } from "@/primitives/navigation-menu"

export function UnavigationUmenuExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
