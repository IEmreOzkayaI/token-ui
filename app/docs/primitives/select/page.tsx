  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uselect component with live examples from ui/components/select-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/select-basic.tsx
import { Component } from "@/primitives/select"

export function UselectExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
