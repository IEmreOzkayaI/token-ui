  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ualert component with live examples from ui/components/alert-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/alert-basic.tsx
import { Component } from "@/primitives/alert"

export function UalertExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
