...
export default function UcontextUmenuPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UcontextUmenu</h1>
        <p className="text-lg text-muted-foreground">UcontextUmenu component with live examples from ui/components/context-menu-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/context-menu-basic.tsx
import { Component } from "@/primitives/context-menu"

export function UcontextUmenuExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
