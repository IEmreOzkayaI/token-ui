...
import { UcontextUmenu } from "@/primitives/context-menu"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UcontextUmenu } from "@/primitives/context-menu"

export function UcontextUmenuDemo() {
  return <UcontextUmenu />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
