  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uspinner component with live examples from ui/components/spinner-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/spinner-basic.tsx
import { Component } from "@/primitives/spinner"

export function UspinnerExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
