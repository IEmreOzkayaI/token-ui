  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <CodeBlock>{`<Input placeholder="Enter text..." />`}</CodeBlock>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <CodeBlock>{`<Input type="email" placeholder="user@example.com" />`}</CodeBlock>
          </div>
          <div>
            <h3 className="font-semibold mb-3">Password</h3>
            <CodeBlock>{`<Input type="password" placeholder="••••••••" />`}</CodeBlock>
          </div>
          <div>
            <h3 className="font-semibold mb-3">Disabled</h3>
            <CodeBlock>{`<Input disabled placeholder="Disabled" />`}</CodeBlock>
          </div>
        </div>
      </section>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-border">
                ...
                <td className="py-2 px-3 text-xs">text</td>
              </tr>
              <tr className="border-b border-border">
