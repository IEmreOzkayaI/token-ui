  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Utooltip component with live examples from ui/components/tooltip-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/tooltip-basic.tsx
import { Component } from "@/primitives/tooltip"

export function UtooltipExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
