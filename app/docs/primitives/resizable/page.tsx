  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uresizable component with live examples from ui/components/resizable-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/resizable-basic.tsx
import { Component } from "@/primitives/resizable"

export function UresizableExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
