  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ucalendar component with live examples from ui/components/calendar-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/calendar-basic.tsx
import { Component } from "@/primitives/calendar"

export function UcalendarExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
