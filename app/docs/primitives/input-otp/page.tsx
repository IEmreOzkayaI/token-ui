  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">UinputUotp component with live examples from ui/components/input-otp-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/input-otp-basic.tsx
import { Component } from "@/primitives/input-otp"

export function UinputUotpExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
