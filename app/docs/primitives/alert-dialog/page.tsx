...
import { UalertUdialog } from "@/primitives/alert-dialog"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UalertUdialog } from "@/primitives/alert-dialog"

export function UalertUdialogDemo() {
  return <UalertUdialog />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
