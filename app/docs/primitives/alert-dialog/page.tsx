...
export default function UalertUdialogPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UalertUdialog</h1>
        <p className="text-lg text-muted-foreground">UalertUdialog component with live examples from ui/components/alert-dialog-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/alert-dialog-basic.tsx
import { Component } from "@/primitives/alert-dialog"

export function UalertUdialogExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
