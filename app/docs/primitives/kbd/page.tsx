  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ukbd component with live examples from ui/components/kbd-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/kbd-basic.tsx
import { Component } from "@/primitives/kbd"

export function UkbdExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
