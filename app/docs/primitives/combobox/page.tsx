  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ucombobox component with live examples from ui/components/combobox-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/combobox-basic.tsx
import { Component } from "@/primitives/combobox"

export function UcomboboxExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
