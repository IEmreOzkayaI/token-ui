...
export default function UbreadcrumbPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">Ubreadcrumb</h1>
        <p className="text-lg text-muted-foreground">Ubreadcrumb component with live examples from ui/components/breadcrumb-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/breadcrumb-basic.tsx
import { Component } from "@/primitives/breadcrumb"

export function UbreadcrumbExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
