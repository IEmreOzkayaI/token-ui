  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Utable component with live examples from ui/components/table-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/table-basic.tsx
import { Component } from "@/primitives/table"

export function UtableExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
