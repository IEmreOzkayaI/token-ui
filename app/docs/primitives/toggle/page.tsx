...
import { Utoggle } from "@/primitives/toggle"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { Utoggle } from "@/primitives/toggle"

export function UtoggleDemo() {
  return <Utoggle />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        ...
        <section id="installation" className="space-y-4">
          ...
          <CodeBlock>{`pnpm dlx shadcn@latest add toggle`}</CodeBlock>
        </section>
