...
export default function UtogglePage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">Utoggle</h1>
        <p className="text-lg text-muted-foreground">Utoggle component with live examples from ui/components/toggle-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/toggle-basic.tsx
import { Component } from "@/primitives/toggle"

export function UtoggleExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
