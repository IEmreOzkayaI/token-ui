  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uempty component with live examples from ui/components/empty-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/empty-basic.tsx
import { Component } from "@/primitives/empty"

export function UemptyExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
