...
export default function UswitchPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">Uswitch</h1>
        <p className="text-lg text-muted-foreground">Uswitch component with live examples from ui/components/switch-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/switch-basic.tsx
import { Component } from "@/primitives/switch"

export function UswitchExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
