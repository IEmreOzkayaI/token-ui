...
export default function UhoverUcardPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UhoverUcard</h1>
        <p className="text-lg text-muted-foreground">UhoverUcard component with live examples from ui/components/hover-card-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/hover-card-basic.tsx
import { Component } from "@/primitives/hover-card"

export function UhoverUcardExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
