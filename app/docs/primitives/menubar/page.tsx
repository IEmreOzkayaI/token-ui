  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Umenubar component with live examples from ui/components/menubar-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/menubar-basic.tsx
import { Component } from "@/primitives/menubar"

export function UmenubarExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
