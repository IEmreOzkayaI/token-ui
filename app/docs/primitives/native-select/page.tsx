...
import { UnativeUselect } from "@/primitives/native-select"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UnativeUselect } from "@/primitives/native-select"

export function UnativeUselectDemo() {
  return <UnativeUselect />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
