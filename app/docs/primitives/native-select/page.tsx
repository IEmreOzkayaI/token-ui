  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">UnativeUselect component with live examples from ui/components/native-select-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/native-select-basic.tsx
import { Component } from "@/primitives/native-select"

export function UnativeUselectExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
