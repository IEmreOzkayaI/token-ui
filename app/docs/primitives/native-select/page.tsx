  ...
  return (
    <div className="space-y-8">
      <section className="space-y-4">
        <h1 className="text-4xl font-bold">NativeSelect</h1>
      ...
      <section className="space-y-4">
        ...
        <CodeBlock>{`import { NativeSelect } from "@/components/primitives/native-select"`}</CodeBlock>
      </section>

      <section className="space-y-4">
        <h2 className="text-2xl font-bold">Usage</h2>
        <CodeBlock>{`<NativeSelect />`}</CodeBlock>
      </section>
