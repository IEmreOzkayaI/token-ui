  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="max-w-2xl flex-1 space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">NativeSelect</h1>
        <p className="text-lg text-muted-foreground">
          NativeSelect component — {examples.length} examples rendered live with source code
        </p>
