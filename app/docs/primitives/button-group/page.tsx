...
export default function UbuttonUgroupPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UbuttonUgroup</h1>
        <p className="text-lg text-muted-foreground">UbuttonUgroup component with live examples from ui/components/button-group-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/button-group-basic.tsx
import { Component } from "@/primitives/button-group"

export function UbuttonUgroupExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
