...
import { UbuttonUgroup } from "@/primitives/button-group"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UbuttonUgroup } from "@/primitives/button-group"

export function UbuttonUgroupDemo() {
  return <UbuttonUgroup />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
