...
export default function UpaginationPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">Upagination</h1>
        <p className="text-lg text-muted-foreground">Upagination component with live examples from ui/components/pagination-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/pagination-basic.tsx
import { Component } from "@/primitives/pagination"

export function UpaginationExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
