...
export default function UtextareaPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Utextarea component with live examples from ui/components/textarea-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/textarea-basic.tsx
import { Component } from "@/primitives/textarea"

export function UtextareaExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
