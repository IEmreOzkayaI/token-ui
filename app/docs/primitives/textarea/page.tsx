...
import { Utextarea } from "@/primitives/textarea"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { Utextarea } from "@/primitives/textarea"

export function UtextareaDemo() {
  return <Utextarea />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        ...
        <section id="installation" className="space-y-4">
          ...
          <CodeBlock>{`pnpm dlx shadcn@latest add textarea`}</CodeBlock>
        </section>
