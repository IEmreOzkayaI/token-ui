...
export default function UdropdownUmenuPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UdropdownUmenu</h1>
        <p className="text-lg text-muted-foreground">UdropdownUmenu component with live examples from ui/components/dropdown-menu-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/dropdown-menu-basic.tsx
import { Component } from "@/primitives/dropdown-menu"

export function UdropdownUmenuExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
