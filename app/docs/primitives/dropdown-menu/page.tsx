...
import { UdropdownUmenu } from "@/primitives/dropdown-menu"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UdropdownUmenu } from "@/primitives/dropdown-menu"

export function UdropdownUmenuDemo() {
  return <UdropdownUmenu />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
