  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Udrawer component with live examples from ui/components/drawer-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/drawer-basic.tsx
import { Component } from "@/primitives/drawer"

export function UdrawerExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
