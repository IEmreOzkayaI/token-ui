  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Uchart component with live examples from ui/components/chart-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/chart-basic.tsx
import { Component } from "@/primitives/chart"

export function UchartExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
