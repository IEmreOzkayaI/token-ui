  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ulabel component with live examples from ui/components/label-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/label-basic.tsx
import { Component } from "@/primitives/label"

export function UlabelExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
