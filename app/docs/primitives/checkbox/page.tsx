  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ucheckbox component with live examples from ui/components/checkbox-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/checkbox-basic.tsx
import { Component } from "@/primitives/checkbox"

export function UcheckboxExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
