  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Utabs component with live examples from ui/components/tabs-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/tabs-basic.tsx
import { Component } from "@/primitives/tabs"

export function UtabsExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
