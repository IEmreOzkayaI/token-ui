...
export default function UscrollUareaPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UscrollUarea</h1>
        <p className="text-lg text-muted-foreground">UscrollUarea component with live examples from ui/components/scroll-area-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/scroll-area-basic.tsx
import { Component } from "@/primitives/scroll-area"

export function UscrollUareaExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
