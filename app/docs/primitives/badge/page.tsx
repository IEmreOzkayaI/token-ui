    ...
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground">Ubadge component with live examples</p>
        </section>
            ...
            <TabsContent value="preview">
              <Preview>
                <div className="text-center text-muted-foreground">
                  Component examples from ui/components/badge-*.tsx
                </div>
              </Preview>
            </TabsContent>
            <TabsContent value="code">
              <CodeBlock>{`import { Component } from "@/primitives/badge"
