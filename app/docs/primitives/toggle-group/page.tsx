...
import { UtoggleUgroup } from "@/primitives/toggle-group"
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { UtoggleUgroup } from "@/primitives/toggle-group"

export function UtoggleUgroupDemo() {
  return <UtoggleUgroup />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
        </section>
