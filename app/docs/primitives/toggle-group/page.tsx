...
export default function UtoggleUgroupPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">UtoggleUgroup</h1>
        <p className="text-lg text-muted-foreground">UtoggleUgroup component with live examples from ui/components/toggle-group-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/toggle-group-basic.tsx
import { Component } from "@/primitives/toggle-group"

export function UtoggleUgroupExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
