...
import { Uskeleton } from "@/primitives/skeleton"
...
export default function UskeletonPage() {
  return (
        ...
        <section id="usage" className="space-y-4">
          ...
          <Tabs defaultValue="code">
            ...
            <TabsContent value="code">
              <CodeBlock>{`import { Uskeleton } from "@/primitives/skeleton"

export function UskeletonDemo() {
  return <Uskeleton />
}`}</CodeBlock>
            </TabsContent>
          </Tabs>
