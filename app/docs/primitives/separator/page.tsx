...
export default function UseparatorPage() {
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">Useparator</h1>
        <p className="text-lg text-muted-foreground">Useparator component with live examples from ui/components/separator-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/separator-basic.tsx
import { Component } from "@/primitives/separator"

export function UseparatorExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
