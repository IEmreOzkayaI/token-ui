  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Usheet component with live examples from ui/components/sheet-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/sheet-basic.tsx
import { Component } from "@/primitives/sheet"

export function UsheetExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
