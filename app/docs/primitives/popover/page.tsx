  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Upopover component with live examples from ui/components/popover-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/popover-basic.tsx
import { Component } from "@/primitives/popover"

export function UpopoverExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
