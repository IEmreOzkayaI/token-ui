  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Ucarousel component with live examples from ui/components/carousel-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/carousel-basic.tsx
import { Component } from "@/primitives/carousel"

export function UcarouselExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
