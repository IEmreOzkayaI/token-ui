  ...
  return (
    <div className="flex gap-12">
      ...
      <div className="flex-1 max-w-2xl space-y-8">
        ...
        <p className="text-lg text-muted-foreground">Udialog component with live examples from ui/components/dialog-*.tsx</p>
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="code">
            <CodeBlock>{`// Example: ui/components/dialog-basic.tsx
import { Component } from "@/primitives/dialog"

export function UdialogExample() {
  return <Component />
}`}</CodeBlock>
          </TabsContent>
        </Tabs>
