...
export const docsNav: NavSection[] = [
  ...
  {
    title: "Prompts",
    href: "/docs/prompts/framework",
    items: [
      { label: "Framework Overview", href: "/docs/prompts/framework" },
      ...
      { label: "─ Component Variant", href: "/docs/prompts/component-variant" },
      ...
      { label: "─ Refactor Prompt", href: "/docs/prompts/refactor" },
      { label: "─ Accessibility Review", href: "/docs/prompts/accessibility" },
      { label: "─ Token Compliance", href: "/docs/prompts/token-compliance" },
      { label: "─ Component Migration", href: "/docs/prompts/migration" },
      { label: "─ Master System Engineer", href: "/docs/prompts/master-system" },
    ],
  },
  {
    title: "Changelog",
