...
7. RESPONSIVE & MOBILE A11Y
   - Layout reflow without loss of content or functionality
   - Touch targets remain usable when stacked on mobile
   - No horizontal scroll traps; chart/table regions scroll intentionally
